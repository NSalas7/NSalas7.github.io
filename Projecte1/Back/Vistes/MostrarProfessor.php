...
<!--    <a href="AfegirProfesor.html" class="btn btn-secondary" role="button" aria-pressed="true" id="botoAfegirExcursio" >Afegir Professor <i class="fa fa-user"></i></a>-->

    <a href="AfegirProfesor.php" class="btn btn-secondary" role="button" aria-pressed="true" id="botoAfegirExcursio" >Afegir Professor <i class="fa fa-user"></i> </a>
