...
<nav class="navbar navbar-expand-lg navbar-light" id="colornavbar">
    <img src="../Public/IMG/logo_negre.png" class="d-inline-block align-top" id="capçaleraBackCards">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent"><br>
        ...
        <a href="MostrarExcursio.php" id="linkExcursions"> Excursions <img src="../Public/IMG/mochila.png" alt="mochila" id="mochilaBoto"></a>
