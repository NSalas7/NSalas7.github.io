...
public function readFront(){
      $query = "select excursio.id as id ,excursio.nom as nom ,excursio.public as publica ,excursio.imatge as imatge,curs.nom as nomCurs ,excursioactual.data_inici as data_inici ,excursioactual.preu as preu from excursio,curs,excursioactual,curs_has_excursioactual where excursio.id = excursioactual.Excursio_id and curs_has_excursioactual.ExcursioActual_id=excursioactual.id and curs_has_excursioactual.Curs_id = curs.id";
      $stmt = $this->conn->prepare($query);
      $stmt->execute();
      $result = $stmt->get_result();
  ...
  public function inserir($nomI,$cursI,$llocI,$duracioI,$d_iniciI,$d_fi,$recorregut,$professors,$descripcioI,$imatge,$publica,$preu){
...
//echo "<br/>";
    ...
    $ex = "INSERT INTO excursio (nom, duracio, descripcio, public, imatge) VALUES ('$nomI','$duracioI','$descripcioI','$publicI','$imatgeI')";
