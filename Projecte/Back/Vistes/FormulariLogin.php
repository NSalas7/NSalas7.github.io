...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Vistes/Estils/fullestil1.css">
...
<div class="container" id="contenidorIniciSessio">
    ...
    <form action="/API/Controladors/Professor/comprovarProfessor.php" method="post" id="formul">
        <div class="form-row">
