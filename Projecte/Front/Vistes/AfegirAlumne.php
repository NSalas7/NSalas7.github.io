        ...
        <form action="http://api.gestioexcursions.me/Controladors/Alumne/inserirAlumne.php" method="POST" id="form">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-9">
              Curs:
              <select id="cursos" name="curs" class="form-control falu">
          ...
          <div class="form-row">
            <div class="form-group col-md-8">
              ...
              Correu Pare, Mare, Tutor: <input type="text" class="form-control falu" name="correuPare" onfocus="protegeCampo(this)" id="correuP" placeholder="Rellenar en cas que l'alumne sigui menor d'edat.">
            </div>
          </div>
          <div class="form-row">
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-8">
              <div id='collapsediv1' class='collapse div1'>
                Correu Alumne: <input type="text" class="form-control falu" name="correuAlumne" placeholder="Rellenar en cas que l'alumne sigui major d'edat.">
              </div>
            </div>
          </div>
          <div class="form-row">
