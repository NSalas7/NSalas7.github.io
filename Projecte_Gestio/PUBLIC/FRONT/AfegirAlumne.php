        ...
        <form action="inserir_alumne.php" method="get" id="form">
          <div class="form-row">
            <div class="form-group col-md-4">
              Nom alumne: <input type="textarea" class="form-control falu" name="nom">
            </div>
            <div class="form-group col-md-4">
              Primer Llinatge:
                <input type="textarea" class="form-control falu" name="llinatge1">
            </div>
            <div class="form-group col-md-4">
              Segon Llinatge:
                <input type="textarea" class="form-control falu"name="llinatge2">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-3">
              Edat de l'Alumne: <input type="text" class="form-control falu" name="edat">
            </div>
            <div class="form-group col-md-9">
              Curs:
                <select type="text" placeholder="Month" class="form-control falu" name="curs">
          ...
          <div class="form-row">
            <div class="form-group col-md-8">
              ...
              Correu Pare, Mare, Tutor: <input type="text" class="form-control falu" name="correuAlumne" onfocus="protegeCampo(this)" id="correuA">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-12">
              Alumne major d'edat? <input type="checkbox" data-toggle="collapse falu" data-target="#collapsediv1" onchange="toggle()" id="checkbox1"> 
            </div>
          </div>
           <div class="form-row">
            ...
            <div class="form-group col-md-8">
              <div id='collapsediv1' class='collapse div1'>
                Correu Alumne: <input type="text" class="form-control falu" name="correuPare" placeholder="Rellenar en cas que l'alumne sigui major d'edat.">
              </div>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              Contrasenya: <input type="password" class="form-control falu" name="contra">
            </div>
          </div>
          <div class="form-row">
